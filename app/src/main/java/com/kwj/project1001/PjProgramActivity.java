...
public class PjProgramActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.w_program);
        ...
        exerLayout[0][0] = R.layout.e_buffytest; exerLayout[0][1] = R.layout.e_lungy; exerLayout[0][2] = R.layout.e_pullup;
        ...
        exerLayout[1][0] = R.layout.e_buffytest; exerLayout[1][1] = R.layout.e_running; exerLayout[1][2] = R.layout.e_pushup;
        ...
        exerLayout[2][0] = R.layout.e_running; exerLayout[2][1] = R.layout.e_bench; exerLayout[2][2] = R.layout.e_lungy;
        ...
        exerLayout[3][0] = R.layout.e_bench; exerLayout[3][1] = R.layout.e_pullup; exerLayout[3][2] = R.layout.e_lungy;
        ...
        exerLayout[4][0] = R.layout.e_lungy; exerLayout[4][1] = R.layout.e_pushup; exerLayout[4][2] = R.layout.e_pullup;
        ...
        exerLayout[5][0] = R.layout.e_buffytest; exerLayout[5][1] = R.layout.e_pushup; exerLayout[5][2] = R.layout.e_lungy;
    }
        ...
        for (Button tmpBtn : program) {
            if (tmpBtn == btn) {
                ...
                try {
                    ...
                    View layout = inflater.inflate(R.layout.w_program+s+1, (ViewGroup) findViewById(R.id.popup));
                    AlertDialog.Builder aDialog = new AlertDialog.Builder(PjProgramActivity.this);
                    ...
                    aDialog.setNegativeButton("시작", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(PjProgramActivity.this, PjProgramMainActivity.class);
